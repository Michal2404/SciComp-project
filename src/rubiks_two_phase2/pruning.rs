...
/// Saves the pruning values for phase 1. Combines the phase 1 coordinates into a single index.
...
/// Saves the pruning values for phase 2. Combines the phase 2 coordinates into a single index.
