...
/// Represantation of the Rubik's Cube on the Facelet level corresponds to an array
/// of length 54 (6 faces * 9 stickers). This representation is important for 
...
impl FaceCube {
    ...
    /// Converts the Facelet representation to the Cubie representation.
